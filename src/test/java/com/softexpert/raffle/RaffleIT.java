...
public class RaffleIT {
	...
	public void fiveWinnersDrawingFromFile() throws RaffleException, IOException {
		List<String> winners = raffle.processWinners("src/test/resources/com/softexpert/name-list-01.txt", 5);
	...
	public void fiveWinnersDrawingSize() throws RaffleException {
		List<String> winners = raffle.processWinners("src/test/resources/com/softexpert/name-list-02.txt", 5);
		MatcherAssert.assertThat(winners, Matchers.hasSize(5));
	}

	@Test
	public void hundredWinnersDrawingSize() throws RaffleException {
		List<String> winners = raffle.processWinners("src/test/resources/com/softexpert/name-list-02.txt", 100);
		MatcherAssert.assertThat(winners, Matchers.hasSize(100));
	}

	@Test
	public void overThousandWinnersDrawingSize() throws RaffleException {
		List<String> winners = raffle.processWinners("src/test/resources/com/softexpert/name-list-03.txt", 1113);
	...
	public void tenThousandWinnersDrawingSize() throws RaffleException {
		...
		List<String> winners = raffle.processWinners("src/test/resources/com/softexpert/name-list-final.txt", FINAL_LIST_SIZE);
